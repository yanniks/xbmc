...
#elif (defined(TARGET_POSIX) || defined(TARGET_DARWIN_OSX)) && !defined(TARGET_DARWIN_IOS)
...
#if !defined(TARGET_ANDROID) && (defined(TARGET_POSIX) || defined(TARGET_DARWIN_OSX)) && !defined(TARGET_DARWIN_IOS)
